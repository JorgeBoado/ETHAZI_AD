...
public abstract class Literales {
    ...
    public static class AdminsLiterals {
        ...
        public static final String ID = "N√∫mero de identificaci√≥n: ";
    ...
    public static class ClientsLiterals {
        ...
        public static final String EMAIL = "Correo electr√≥nico: ";
        public static final String ID = "N√∫mero de identificaci√≥n: ";
        public static final String NICK = "Nick: ";
    }
    ...
    public static class ToolTips{
    	...
    	public static final String OFF = "Cerrar sesiÛn"; 
    	public static final String NEXTPAGE = "P·°gina siguiente"; 
    	public static final String LASTPAGE = "P·°gina anterior"; 
    }
}
